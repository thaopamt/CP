...
export const QUESTS: QuestSeed[] = [
  ...
  { title: 'Tích XP mỗi ngày', description: 'Giải 2 bài lập trình trong ngày để nhận thêm XP.', type: QuestType.DAILY, objectiveType: QuestObjectiveType.SOLVE_CODING, targetCount: 2, rewardXp: 40, rewardGems: 6, icon: 'auto_graph', recurrence: QuestRecurrence.DAILY, sortOrder: 7, category: 'Daily' },
  ...
  { title: 'Chăm chỉ cả tuần', description: 'Nộp đúng 5 bài trong tuần.', type: QuestType.WEEKLY, objectiveType: QuestObjectiveType.SUBMIT_ACCEPTED, targetCount: 5, rewardXp: 280, rewardGems: 35, icon: 'event_available', recurrence: QuestRecurrence.WEEKLY, sortOrder: 6, category: 'Weekly' },
  ...
  { title: 'Marathon 7 ngày', description: 'Giải 7 bài lập trình trong thời gian sự kiện.', type: QuestType.EVENT, objectiveType: QuestObjectiveType.SOLVE_CODING, targetCount: 7, rewardXp: 800, rewardGems: 90, icon: 'directions_run', recurrence: QuestRecurrence.BIWEEKLY, sortOrder: 6, category: 'Event' },
  { title: 'Vượt cấp tốc hành', description: 'Giải 12 bài độ khó MEDIUM trong thời gian sự kiện.', type: QuestType.EVENT, objectiveType: QuestObjectiveType.SOLVE_BY_DIFFICULTY, objectiveConfig: { difficulty: 'MEDIUM' }, targetCount: 12, rewardXp: 1500, rewardGems: 160, icon: 'rocket', recurrence: QuestRecurrence.BIWEEKLY, sortOrder: 7, category: 'Event' },
