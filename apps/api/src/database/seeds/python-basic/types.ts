/**
 * Shared shapes for the PYTHON BASIC seed curriculum.
 *
 * Each course (e.g. "Câu lệnh if", "Vòng lặp for") is a CourseSpec holding ~30
...
export interface CourseSpec {
  /** Stable natural key, e.g. 'PYTHON-BASIC-01'. Drives upsert + ordering. */
  code: string;
  title: string;
  description: string;
  tags: string[];
