...
export function AttendancePanel({ classId, date, onClose }: AttendancePanelProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end bg-black/40 backdrop-blur-sm transition-opacity">
      <div className="flex w-full max-w-2xl flex-col bg-surface shadow-elev-3 h-full max-h-[100dvh] animate-in slide-in-from-right overflow-hidden">
        {/* Header */}
        ...
        <div className="flex-1 overflow-y-auto min-h-0">
          <div className="p-lg flex flex-col gap-lg min-h-min">
        ...
        {/* Footer */}
        <div className="shrink-0 flex items-center justify-end gap-md border-t border-outline-variant px-lg py-md bg-surface-container-lowest">
          {isDirty && (
