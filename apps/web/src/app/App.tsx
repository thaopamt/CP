...
const AdminFinanceInvoiceBuilder = lazy(() => import('./pages/admin/FinanceInvoiceBuilderPage'));
          ...
          <ThemeProvider>
            ...
            <Routes>
              ...
              >
                ...
                <Route path="finance/invoice/:studentId" element={<AdminFinanceInvoiceBuilder />} />
